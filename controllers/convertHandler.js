function ConvertHandler() {
  ...
  this.getNum = function(input) {
    ...
    let numRegex = /^[\d\.\/]+/;
    let numStr = input.match(numRegex) ? input.match(numRegex)[0] : '';
    
    if(numStr === '') return 1; // défaut à 1 si aucun nombre
    
    // Vérifier les doubles fractions
